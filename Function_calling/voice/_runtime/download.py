...
def download_from_hf(repo_id: str, filename: str | os.PathLike):
    # _runtime/download.py → Function_calling/models/ (standalone layout)
    _fc_root = Path(__file__).resolve().parent.parent.parent
    base_dir = os.getenv("MODELS", str(_fc_root / "models"))
